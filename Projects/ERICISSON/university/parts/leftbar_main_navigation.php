<div id="left-sidebar" class="sidebar">
    <h5 class="brand-name">Dashboard<a href="javascript:void(0)" class="menu_option float-right"><i class="icon-grid font-16" data-toggle="tooltip" data-placement="left" title="Grid & List Toggle"></i></a></h5>
