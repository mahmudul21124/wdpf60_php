...
<!-- CSS -->
 <?php include "parts/css_file.php" ?>
...
<div id="main_content">
    ...
    <?php include "parts/top_header.php" ?>
    <!-- End Main top header -->

    <!-- Start Rightbar setting panel -->
    <?php include "parts/rightbar_setting_panel.php" ?>
    <!-- End Rightbar setting panel -->
    ...
    <div class="page">
        ...
        <?php include "parts/page_title_tab.php" ?>
        <!-- End Page title and tab -->
