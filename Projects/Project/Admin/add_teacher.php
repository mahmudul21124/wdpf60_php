                                        ...
                                        <div class="card-body">
                                            ...
                                            if (isset($_POST['submit'])) {
                                                ...
                                                if (move_uploaded_file($photo_tname, $path . $photo_name)) {
                                                    $db->query("INSERT INTO teachers(id, name, department, photo, address, fees, contact_no, email, password) VALUES (NULL, '$department', '$name', '$photo_name', '$address', '$fees', '$contact', '$email', '$pass')");
