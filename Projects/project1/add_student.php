                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            if (isset($_POST['submit'])) {
                                                ...
                                                echo "INSERT INTO students(roll_no, name, parents_name, photo, department, class, gender, dob, contact_no, address,  email, password) VALUES('$roll_no', '$name', '$pname' '$photo_name', '$department', '$cls', '$gender', '$bdate', '$contact', '$address', '$email', '$pass')";

                                                if (move_uploaded_file($photo_tname, $path . $photo_name)) {
                                                    $db->query("INSERT INTO students(roll_no, name, parents_name, photo, department, class, gender, dob, contact_no, address,  email, password) VALUES('$roll_no', '$name', '$pname' '$photo_name', '$department', '$cls', '$gender', '$bdate', '$contact', '$address', '$email', '$pass')");
                                            ...
                                            <form class="" action="" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    Male <input type="radio" class="form-control-m"  name="gender" value="Male" required/>
                                                    Female <input type="radio" class="form-control-m"  name="gender" value="Female" required/>
                                                </div>
                                                <div class="form-group">
