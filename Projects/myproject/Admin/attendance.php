        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Attendance</h4>
                </div>
                <!-- /Title -->
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="table-wrap">
                                        ...
                                        $sql = $db->query("SELECT * FROM attendance");
                                        $sn = 1;
                                        ?>
