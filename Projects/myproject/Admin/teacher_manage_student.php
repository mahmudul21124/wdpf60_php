                                        ...
                                        <table id="datable_3" class="table table-neon text-default w-100 display">
                                            ...
                                            <?php while($row = $sql->fetch_assoc()){ ?>
                                                <tr>
                                                    ...
                                                    <td><a href="teacher_student_edit.php?id=<?php echo $row['id'] ?>" class="btn btn-outline-info btn-rounded">Edit</a> | 
                                                    <a onclick="return confirm('Are you sure to delete?')" href="teacher_student_delete.php?did=<?php echo $row['id'] ?>" class="btn btn-outline-danger btn-rounded">Delete</a></td>
                                                </tr>
                                            <?php $sn++;
                                                } ?>
                                            </tbody>
