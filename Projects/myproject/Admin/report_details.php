            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        $sql = $db->query("SELECT * FROM students where date(students.creationDate) between '$fdate' and '$tdate'");
                        $sn = 1;

                        ?>
                        <section class="hk-sec-wrapper">
                            <h5 class="hk-sec-title" align="center" style="color:blue">Students report from <?php echo $fdate ?> to <?php echo $tdate ?></h5>
                            <div class="row">
                                <div class="col-sm">
