...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 29, 2024 at 08:51 AM
...
ALTER TABLE `products` ADD FULLTEXT KEY `productDescription` (`productDescription`);
--
-- Database: `evidence`
--
DROP DATABASE IF EXISTS `evidence`;
CREATE DATABASE IF NOT EXISTS `evidence` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `evidence`;
...
--
DROP TRIGGER IF EXISTS `Manufacturer_Delete`;
DELIMITER $$
...
DROP TABLE IF EXISTS `manufacturer_bk`;
...
--
DROP VIEW IF EXISTS `products_above_5000`;
...
-- Database: `tclk60`
--
DROP DATABASE IF EXISTS `tclk60`;
CREATE DATABASE IF NOT EXISTS `tclk60` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `tclk60`;
...
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `product_above_5000`;
...
-- Database: `wdpf60`
--
DROP DATABASE IF EXISTS `wdpf60`;
CREATE DATABASE IF NOT EXISTS `wdpf60` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `wdpf60`;
...
--
DROP DATABASE IF EXISTS `wdpf60_transaction`;
CREATE DATABASE IF NOT EXISTS `wdpf60_transaction` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `wdpf60_transaction`;
