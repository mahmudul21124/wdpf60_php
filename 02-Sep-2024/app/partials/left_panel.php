<div class="br-sideleft sideleft-scrollbar">
      ...
      <ul class="br-sideleft-menu">
        ...
        <li class="br-menu-item">
          <a href="template/mailbox.html" class="br-menu-link">
        ...
        <li class="br-menu-item">
          ...
          <ul class="br-menu-sub">
            <li class="sub-item"><a href="template/card-dashboard.html" class="sub-link">Dashboard</a></li>
            <li class="sub-item"><a href="template/card-social.html" class="sub-link">Blog &amp; Social Media</a></li>
            <li class="sub-item"><a href="template/card-listing.html" class="sub-link">Shop &amp; Listing</a></li>
          </ul>
        </li>
        <li class="br-menu-item">
          <a href="#" class="br-menu-link with-sub">
          ...
          <ul class="br-menu-sub">
            <li class="sub-item"><a href="template/accordion.html" class="sub-link">Accordion</a></li>
            <li class="sub-item"><a href="template/alerts.html" class="sub-link">Alerts</a></li>
